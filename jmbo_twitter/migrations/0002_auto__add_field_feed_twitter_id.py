...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.twitter_id'
        db.add_column('jmbo_twitter_feed', 'twitter_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.twitter_id'
    ...
    models = {
        ...
        'jmbo_twitter.feed': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Feed', '_ormbases': ['jmbo.ModelBase']},
        ...
        'jmbo_twitter.status': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Status', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'photologue.photo': {
