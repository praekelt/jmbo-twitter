...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'jmbo_twitter.feed': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Feed', '_ormbases': ['jmbo.ModelBase']},
            ...
            'twitter_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
        'jmbo_twitter.search': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Search', '_ormbases': ['jmbo.ModelBase']},
            'criteria': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'jmbo_twitter.status': {
            'Meta': {'ordering': "('-publish_on', '-created')", 'object_name': 'Status', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'photologue.photo': {
